...
document.addEventListener('DOMContentLoaded', function() {
    const certificationsData = [
        {
            ...
            credentialUrl: "https://www.coursera.org/account/accomplishments/certificate/63GEGSFGAT5X"
        },
        {
            ...
            credentialUrl: "https://www.coursera.org/account/accomplishments/certificate/J7ZTLUR45NHA"
        },
        {
            ...
            credentialUrl: "https://www.linkedin.com/in/vinitjuneja/details/certifications/"
        },
        {
        ...
        },
        {
            ...
            credentialUrl: "https://www.coursera.org/account/accomplishments/certificate/8JLN6NJUKT4S"
        },
        {
            ...
            credentialUrl: "https://fsp-assessment-certificates.s3-ap-southeast-1.amazonaws.com/VinitJuneja-65685194.pdf"
        },
        {
            title: "Statistics",
            ...
            credentialUrl: "https://www.coursera.org/account/accomplishments/certificate/DP3ABFP6HNCX"
        }
    ];
    ...
    function createCards() {
        certificationsData.forEach((cert, index) => {
            ...
            card.setAttribute('aria-label', `${cert.title} certification from ${cert.issuer}`);
    ...
    function updateCarousel(index, animate = true) {
        ...
        currentIndex = (index + certificationsData.length) % certificationsData.length;
    ...
    function handleKeydown(e) {
        switch(e.key) {
            case 'ArrowLeft':
                currentIndex = (currentIndex - 1 + certificationsData.length) % certificationsData.length;
                updateCarousel(currentIndex);
                break;
            case 'ArrowRight':
                currentIndex = (currentIndex + 1) % certificationsData.length;
