document.addEventListener("DOMContentLoaded", function () {
  ...
  const projects = [
    ...
    },
    {
      ...
      title:
        "New Players on the Block: Can India’s Discount Brokerages Sustain Market Share?",
      description:
        "Analyzed the competitive dynamics of India’s discount brokerages (e.g., Zerodha, Groww, Upstox) using game theory, assessing their market share sustainability against traditional brokers like ICICI and HDFC Securities. This business strategy project explored innovation, cost structures, and customer value propositions.",
      category: "business",
    },
    {
      id: "resy-analysis",
      ...
      description:
        'Conducted a product analysis of Resy’s dining reservation platform, focusing on AI-driven personalization, dynamic pricing, and real-time updates, proposing improvements for tech-savvy diners and restaurant managers. This business project reimagined the platform as "DineFlow" for enhanced user experience.',
      category: "business",
    },
    {
      id: "zenlock",
      ...
      description:
        "Developed a pitch for ZenLock, a smart shield to reduce screen time, targeting tech-savvy users and schools with RFID/Bluetooth technology, addressing the attention economy’s impact on digital habits. This business project outlined hardware sales, incentives, and school partnerships for monetization.",
      category: "business",
    },
    {
      id: "yuan-ze",
    ...
    },
    {
      ...
      description:
        "During a 2-month internship in 2021, I built and deployed a Microsoft Teams clone using React, Node.js, Express, Socket.io, and WebRTC, leveraging Microsoft Azure for CI/CD deployment. This technical project showcased my web development and deployment skills, creating a functional communication platform.",
      category: "technical",
    },
    {
    ...
    },
    {
      ...
      description:
        "Built a multi-label classification model using Deep Learning and NLP to classify resumes into IT job categories, integrating a Resume Parser with NER, DNN, CNN, LSTM, and BERT, using Python libraries like TensorFlow and SpaCy. This technical project enhanced job matching efficiency for IT roles.",
      category: "technical",
    },
    {
      id: "healthcare-ml",
      ...
      title:
        "Role of Machine Learning Approaches in Optimization of AI-Based Industry 4.0 Healthcare Management Systems",
      description:
        "Researched ML approaches to enhance AI-based healthcare systems, focusing on accuracy in medicine prescription and disease detection, integrating compression and optimization for improved performance. This technical project explored AI, robotics, and automation in healthcare.",
      category: "technical",
    },
    {
      id: "iot-optimization",
      ...
      description:
        "Developed an optimized dataset using PSO techniques for IoT services in smart cities, improving prediction performance and decision-making efficiency with simulations for reduced time and enhanced accuracy. This technical project addressed urban IoT challenges.",
      category: "technical",
    },
    {
      ...
      description:
        "Enhanced sentiment analysis on Twitter data using a hybrid model with compression, noise removal, and CNN, improving accuracy and performance for understanding public opinion on social media. This technical project leveraged advanced ML techniques for real-world applications.",
      category: "technical",
    },
  ];
